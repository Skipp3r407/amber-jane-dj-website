      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        ...
        <div className="mt-10 space-y-8 rounded-3xl border border-white/10 bg-midnight/25 p-8 text-sm leading-relaxed text-muted">
          <SectionReveal variant="left">
            <HeadlineTitle as="h2" size="subsection" titleGradient="One-liner" />
            <p className="mt-2">
          ...
          <SectionReveal variant="right" delay={0.05}>
            <HeadlineTitle as="h2" size="subsection" titleGradient="Short bio" />
            <p className="mt-2">
          ...
          <SectionReveal variant="up" delay={0.08}>
            <HeadlineTitle as="h2" size="subsection" titleGradient="Booking" />
            <p className="mt-2">
              {site.email} · {site.phone}
            </p>
          </SectionReveal>
          <SectionReveal variant="down" delay={0.1}>
            <HeadlineTitle as="h2" size="subsection" titleGradient="Assets" />
